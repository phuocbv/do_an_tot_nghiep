    ...
    @if ($course)
        <div class="table-responsive student-assign">
            <table id="timekeeping" class="table table-bordered">
                ...
                ?>
                @foreach($course->companyInternShipCourse as $companyInternShipCourse)
                    <?php
                    ...
                    ?>
                    <tr>
                        <td><input type="checkbox" name="selectTimekeeping[]" value="{{ $companyInternShipCourse->id }}"
                                   class="selectTimekeeping">
                        </td>
                        <td>
                            {{ $companyInternShipCourse->company->name }}
                        </td>
...
<script>
    ...
    $('.print-timekeeping').click(function () {
        ...
        w.document.write($("#" + cicID + "timekeeping").html());
