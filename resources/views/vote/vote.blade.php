...
@section('user-content')
    ...
    <div class="row well well-sm" style="margin-left: 0px;margin-right: 0px;margin-bottom: -1px">
        <a href="statistic-vote" style="color: #333">
            <span class="company-register name-page-profile">Thống kê Đánh giá của sinh viên về doanh nghiệp</span>
        </a>
    </div>
