                                    ...
                                    <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"
                                                ...
                                                <textarea name="work" id="work" cols="30" rows="4"
                                                          class="form-control"></textarea>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"
                                                 style="font-weight: bold">
                                                II, Kết quả thực hiện<br>
                                                <textarea name="result" id="result" cols="30" rows="4"
                                                          class="form-control"></textarea>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"
                                                 style="font-weight: bold">
                                ...
                                <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10" id="student-view">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="font-weight: bold">
                                            - Nhược điểm<br>
                                            @foreach($studentReport as $sr)
                                                <p style="font-weight: normal; margin-left: 15px"> {!! nl2br(e($sr->dis_advantage)) !!}</p>
                                            @endforeach
