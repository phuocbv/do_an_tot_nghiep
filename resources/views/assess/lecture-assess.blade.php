                            ...
                            <div class="table-responsive lecture-assess">
                                <table id="table-current" class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th style="min-width: 124px">Tên sinh viên</th>
                                        <th style="min-width: 136px;word-wrap: break">Công ty</th>
                                        <th style="min-width: 70px">Chấm công</th>
                                    ...
                                    <tr>
                                        ...
                                        <th style="min-width: 69px">MSV</th>
                                        <th style="min-width: 124px">Tên sinh viên</th>
                                        <th style="min-width:136px">Công ty</th>
                                        <th style="min-width: 70px">Chấm công</th>
                                        <th style="min-width: 56px">
                                            <span>Nhận xét</span><br>
                                            (Công ty)
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                                ...
                                                                <div>
                                                                    @foreach($lectureReport as $lr)
                                                                        ...
                                                                        <textarea name="advantage" id="" rows="4"
                                                                                  class="form-control">
                                                                            {{$lr->advantage}}
                                                                        </textarea>
                                                                        <br>
                                                                        <label>Khó khăn</label>
                                                                        <textarea name="disAdvantage" id="" rows="4"
                                                                                  class="form-control">
                                                                            {{$lr->dis_advantage}}
                                                                        </textarea>
                                                                        ...
                                                                        <textarea name="proposal" id="" rows="4"
                                                                                  class="form-control">
                                                                            {{$lr->proposal}}
                                                                        </textarea>
                                                                        <br>
                                                                        <label>Đánh giá chung</label>
                                                                        <textarea name="assessGeneral" id="" rows="4"
                                                                                  class="form-control">
                                                                            {{$lr->assess_general}}
                                                                        </textarea>
                                                                    @endforeach
                                                    ...
                                                    @endforeach
                                                                ...
                                                                <div class="row">
                                                                    @foreach($company as $c)
                                                                        ...
                                                                        <br>
                                                                        <span>Người phụ trách: {{$c->hr_name}}</span>
                                                                        <br>
