...
@section('user-content')
    ...
    <div class="row well well-sm" style="margin-left: 0px;margin-right: 0px;margin-bottom: -1px">
        ...
        <a href="company-edit-pass" style="color: #333">
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <div class="panel panel-default" style="background-color: #ECECEC;">
                    ...
                    <div class="panel-body">
                        <form action="company-change-pass-form" method="POST" role="form" id="student">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <input type="hidden" name="myUserID" value="{{encrypt($myUserID)}}">
    ...
    <script>
        $(document).ready(function () {
            $('#companyChangePass').addClass('menu-menu');
            $('a#companyChangePass').css('color', '#000000');
            $('#student').validate({
                rules: {
                    password: {
                        required: true,
